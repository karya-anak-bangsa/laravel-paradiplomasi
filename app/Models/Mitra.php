...
class Mitra extends Model
{
     ...
     * MisiAsingAsean, atau MisiPermanenAsean), sesuai `tipe_mitra`.
     * Panggil dengan eager-load ketiga relasi (with('kedutaanBesar',
     * 'misiAsingAsean', 'misiPermanenAsean')) untuk hindari N+1.
     */
    public function subtype(): KedutaanBesar|MisiAsingAsean|MisiPermanenAsean|null
    {
        return $this->kedutaanBesar ?? $this->misiAsingAsean ?? $this->misiPermanenAsean;
    }
