...
class UpdateMisiPermanenAseanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'nama_misi_permanen_asean_id'  => ['required', 'string'],
            'nama_misi_permanen_asean_en'  => ['required', 'string'],
    ...
    public function attributes(): array
    {
        return [
            ...
            'nama_misi_permanen_asean_id' => 'Nama Misi (ID)',
            'nama_misi_permanen_asean_en' => 'Nama Misi (EN)',
