...
!(function (e, t) {
        ...
        off(t, s) {
            ...
            0 !== i
                ? e(t, (e) => {
                      ...
                      const t = this._events[e];
                      void 0 !== t &&
                          (t.splice(t.indexOf(s), 1), (this._events[e] = t));
                  })
                : (this._events = {});
        }
        trigger(t, ...s) {
            ...
            for (let i = 0; i < e.length; i++) {
                ...
                for (const e of s) {
                    ...
                    if (!t || 1 == t.length || t.end <= i)
                        ...
                        let s = e.clone(i, t);
                        const n = r.length;
                        (s.add({ start: i, end: i + n, length: n, substr: r }),
                            l.push(s));
                    } else a.add("3");
                }
                if (l.length > 0) {
    ...
    class T {
        ...
        _getSortFunction(e) {
            ...
            if (o)
                for (let t of o) (e.query || "$score" !== t.field) && s.push(t);
            if (e.query) {
                t = !0;
                for (let e of s)
                    if ("$score" === e.field) {
    ...
    const P = (e) => (null == e ? null : N(e)),
        ...
        $ = (e, t) => {
            ...
            return function (i, n) {
                var o = this;
                (s &&
                    ((o.loading = Math.max(o.loading - 1, 0)), clearTimeout(s)),
                ...
                initializePlugins(e) {
                    ...
                    if (Array.isArray(e))
                        e.forEach((e) => {
                            "string" == typeof e
                                ? n.push(e)
                                : ((i.plugins.settings[e.name] = e.options),
                                  n.push(e.name));
                        });
                    else if (e)
                        for (t in e)
        ...
        ce.define("checkbox_options", function (e) {
            ...
            var n = function (e, t) {
                    t
                        ...
                        : ((e.checked = !1),
                          i.checkedClassNames &&
                              e.classList.remove(...i.checkedClassNames),
                          i.uncheckedClassNames &&
                ...
                e.hook("instead", "loadCallback", (t, s) => {
                    if (l) {
                        if (o) {
                            const s = t[0];
                            void 0 !== s &&
                                (o.dataset.value = s[e.settings.valueField]);
                        }
