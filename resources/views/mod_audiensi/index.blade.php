    ...
    <x-page-body-table title="Daftar audiensi dengan perwakilan negara asing">
        <x-slot name="thead">
            <tr>
                ...
                <th data-orderable="true" style="width:35%" class="text-start">Topik</th>
                    ...
                    <td class="text-center">
                        <div class="btn-list flex-nowrap justify-content-center">
                            ...
                            @if (session('auth_role') === 'admin')
                                ...
                                <form action="{{ route('audiensi.destroy', $item) }}" method="post" class="d-inline"
                                    onsubmit="return confirm('Nonaktifkan audiensi ini?')">
                                    @csrf @method('DELETE')
