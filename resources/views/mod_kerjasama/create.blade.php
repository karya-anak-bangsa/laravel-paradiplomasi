        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Form Tambah Kerjasama</h3>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('kerjasama.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="kerjasama" class="form-control" rows="5" placeholder="Tuliskan judul/isi kerjasama"></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Rangkuman</label>
                            <textarea name="rangkuman" class="form-control" rows="12" placeholder="Rangkuman singkat kerjasama"></textarea>
                        </div>
                        <div class="mb-3">
