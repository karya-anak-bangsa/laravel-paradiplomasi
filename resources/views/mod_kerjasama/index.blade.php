...
@section('page-content')
    ...
    <x-page-body-filter :statusOptions="$statusOptions" :tahunOptions="$tahunOptions" :modul="App\Enums\ModulDiplomasi::Kerjasama" />
                    ...
                    <td class="text-center">
                        <div class="btn-list flex-nowrap justify-content-center">
                            ...
                            @if (session('auth_role') === 'admin')
                                ...
                                <form action="{{ route('kerjasama.destroy', $item) }}" method="post" class="confirm-submit d-inline" data-confirm="delete">
                                    @csrf @method('DELETE')
