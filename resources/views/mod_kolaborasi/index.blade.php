...
@section('page-content')
    <x-page-body-filter :statusOptions="$statusOptions" :tahunOptions="$tahunOptions" :modul="App\Enums\ModulDiplomasi::Kolaborasi" />
    ...
    <x-page-body-table title="Daftar kolaborasi dengan perwakilan negara asing">
        <x-slot name="thead">
            <tr>
                ...
                <th data-orderable="true" style="width:30%" class="text-start">Kolaborasi</th>
