    ...
    <x-page-body-table title="Daftar kolaborasi dengan perwakilan negara asing">
        <x-slot name="thead">
            <tr>
                ...
                <th data-orderable="true" style="width:35%" class="text-start">Kolaborasi</th>
                    ...
                    <td class="text-center">
                        <div class="btn-list flex-nowrap justify-content-center">
                            ...
                            @if (session('auth_role') === 'admin')
                                ...
                                <form action="{{ route('kolaborasi.destroy', $item) }}" method="post" class="d-inline"
                                    onsubmit="return confirm('Nonaktifkan kolaborasi ini?')">
                                    @csrf @method('DELETE')
