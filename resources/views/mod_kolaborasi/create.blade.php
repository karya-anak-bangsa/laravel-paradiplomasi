        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Form Tambah Kolaborasi</h3>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('kolaborasi.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="kolaborasi" class="form-control" rows="5" placeholder="Tuliskan isi kolaborasi"></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Rangkuman</label>
                            <textarea name="rangkuman" class="form-control" rows="12" placeholder="Rangkuman singkat kolaborasi"></textarea>
                        </div>
                        <div class="mb-3">
