                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown @yield('nav-mitra-kami')">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="{{ route('kbri.index') }}">KBRI</a>
                                    <a class="dropdown-item" href="{{ route('kjri.index') }}">KJRI</a>
                                    <a class="dropdown-item" href="{{ route('ptri.index') }}">PTRI</a>
                                </div>
                            </li>
                            ...
                            @if (session('auth_role') === 'admin')
                                ...
                                <li class="nav-item dropdown @yield('nav-pengaturan')">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="{{ route('restore-data.index') }}">Restore Data</a>
                                    </div>
                                </li>
                            @endif
                        </ul>
