<div class="mb-0">
    ...
    <div class="tab-content my-3">
        ...
        <div class="tab-pane active show" id="tab-kerjasama" role="tabpanel">
            @if ($misiPermanenAsean->kerjasama->isNotEmpty())
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @foreach ($misiPermanenAsean->kerjasama as $item)
                                <tr>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title">Rincian Kerjasama - {{ $misiPermanenAsean->mitra->nama_mitra }}</h3>
        ...
        <div class="tab-pane" id="tab-kolaborasi" role="tabpanel">
            @if ($misiPermanenAsean->kolaborasi->isNotEmpty())
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($misiPermanenAsean->kolaborasi as $item)
                                <tr>
                ...
                @foreach ($misiPermanenAsean->kolaborasi as $item)
                    <div class="modal modal-blur fade" id="modal-kolaborasi-{{ $item->id_kolaborasi }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title">Rincian Kolaborasi - {{ $misiPermanenAsean->mitra->nama_mitra }}</h3>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
        ...
        <div class="tab-pane" id="tab-undangan" role="tabpanel">
            @if ($misiPermanenAsean->undangan->isNotEmpty())
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($misiPermanenAsean->undangan as $item)
                                <tr>
                ...
                @foreach ($misiPermanenAsean->undangan as $item)
                    <div class="modal modal-blur fade" id="modal-undangan-{{ $item->id_undangan }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title">Rincian Undangan - {{ $misiPermanenAsean->mitra->nama_mitra }}</h3>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
        ...
        <div class="tab-pane" id="tab-audiensi" role="tabpanel">
            @if ($misiPermanenAsean->audiensi->isNotEmpty())
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($misiPermanenAsean->audiensi as $item)
                                <tr>
                ...
                @foreach ($misiPermanenAsean->audiensi as $item)
                    <div class="modal modal-blur fade" id="modal-audiensi-{{ $item->id_audiensi }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title">Rincian Audiensi - {{ $misiPermanenAsean->mitra->nama_mitra }}</h3>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
        ...
        <div class="tab-pane" id="tab-kunjungan" role="tabpanel">
            @if ($misiPermanenAsean->kunjungan->isNotEmpty())
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($misiPermanenAsean->kunjungan as $item)
                                <tr>
                ...
                @foreach ($misiPermanenAsean->kunjungan as $item)
                    <div class="modal modal-blur fade" id="modal-kunjungan-{{ $item->id_kunjungan }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title">Rincian Kunjungan - {{ $misiPermanenAsean->mitra->nama_mitra }}</h3>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
