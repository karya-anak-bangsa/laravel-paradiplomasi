<div class="mb-0">
    ...
    <div class="tab-content my-3">
        ...
        <div class="tab-pane active show" id="tab-kerjasama" role="tabpanel">
            @if ($nonPerwakilanNegaraAsing->kerjasama->isNotEmpty())
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @foreach ($nonPerwakilanNegaraAsing->kerjasama as $item)
                                <tr>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title">Rincian Kerjasama - {{ $nonPerwakilanNegaraAsing->mitra->nama_resmi_mitra }}</h3>
                                    ...
                                    <div class="datagrid align-items-center mb-3">
                                        <div class="datagrid-item">
                                            <div class="datagrid-content d-flex align-items-center">
                                                ...
                                                <span class="fw-bold">{{ $nonPerwakilanNegaraAsing->mitra->nama_resmi_mitra }}</span>
                                            </div>
                                        </div>
                                        <div class="datagrid-item">
                                            <div class="datagrid-title">Tipe Mitra</div>
                                            <div class="datagrid-content">{{ $nonPerwakilanNegaraAsing->mitra->tipe_mitra->value }}</div>
                                        </div>
                                    </div>
                ...
                @endforeach
            @else
                <p class="text-danger mb-0">Belum ada riwayat kerjasama untuk mitra ini.</p>
            @endif
        </div>

        {{-- Kolaborasi --}}
        <div class="tab-pane" id="tab-kolaborasi" role="tabpanel">
            @if ($nonPerwakilanNegaraAsing->kolaborasi->isNotEmpty())
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($nonPerwakilanNegaraAsing->kolaborasi as $item)
                                <tr>
                ...
                @foreach ($nonPerwakilanNegaraAsing->kolaborasi as $item)
                    <div class="modal modal-blur fade" id="modal-kolaborasi-{{ $item->id_kolaborasi }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title">Rincian Kolaborasi - {{ $nonPerwakilanNegaraAsing->mitra->nama_resmi_mitra }}</h3>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                ...
                @endforeach
            @else
                <p class="text-danger mb-0">Belum ada riwayat kolaborasi untuk mitra ini.</p>
            @endif
        </div>

        {{-- Undangan --}}
        <div class="tab-pane" id="tab-undangan" role="tabpanel">
            @if ($nonPerwakilanNegaraAsing->undangan->isNotEmpty())
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($nonPerwakilanNegaraAsing->undangan as $item)
                                <tr>
                ...
                @foreach ($nonPerwakilanNegaraAsing->undangan as $item)
                    <div class="modal modal-blur fade" id="modal-undangan-{{ $item->id_undangan }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title">Rincian Undangan - {{ $nonPerwakilanNegaraAsing->mitra->nama_resmi_mitra }}</h3>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                ...
                @endforeach
            @else
                <p class="text-danger mb-0">Belum ada riwayat undangan untuk mitra ini.</p>
            @endif
        </div>

        {{-- Audiensi --}}
        <div class="tab-pane" id="tab-audiensi" role="tabpanel">
            @if ($nonPerwakilanNegaraAsing->audiensi->isNotEmpty())
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($nonPerwakilanNegaraAsing->audiensi as $item)
                                <tr>
                ...
                @foreach ($nonPerwakilanNegaraAsing->audiensi as $item)
                    <div class="modal modal-blur fade" id="modal-audiensi-{{ $item->id_audiensi }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title">Rincian Audiensi - {{ $nonPerwakilanNegaraAsing->mitra->nama_resmi_mitra }}</h3>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                ...
                @endforeach
            @else
                <p class="text-danger mb-0">Belum ada riwayat audiensi untuk mitra ini.</p>
            @endif
        </div>

        {{-- Kunjungan --}}
        <div class="tab-pane" id="tab-kunjungan" role="tabpanel">
            @if ($nonPerwakilanNegaraAsing->kunjungan->isNotEmpty())
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($nonPerwakilanNegaraAsing->kunjungan as $item)
                                <tr>
                ...
                @foreach ($nonPerwakilanNegaraAsing->kunjungan as $item)
                    <div class="modal modal-blur fade" id="modal-kunjungan-{{ $item->id_kunjungan }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title">Rincian Kunjungan - {{ $nonPerwakilanNegaraAsing->mitra->nama_resmi_mitra }}</h3>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                ...
                @endforeach
            @else
                <p class="text-danger mb-0">Belum ada riwayat kunjungan untuk mitra ini.</p>
            @endif
        </div>

        {{-- Acara DKI --}}
        <div class="tab-pane" id="tab-acara-dki" role="tabpanel">
            @if ($nonPerwakilanNegaraAsing->acaraDki->isNotEmpty())
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($nonPerwakilanNegaraAsing->acaraDki as $item)
                                <tr>
                ...
                @foreach ($nonPerwakilanNegaraAsing->acaraDki as $item)
                    <div class="modal modal-blur fade" id="modal-acara-dki-{{ $item->id_acara_dki }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title">Rincian Acara DKI - {{ $nonPerwakilanNegaraAsing->mitra->nama_resmi_mitra }}</h3>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                ...
                @endforeach
            @else
                <p class="text-danger mb-0">Belum ada riwayat acara DKI untuk mitra ini.</p>
            @endif
        </div>
