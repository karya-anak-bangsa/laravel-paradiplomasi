<div class="mb-0">
    ...
    <div class="tab-content my-3">
        ...
        <div class="tab-pane" id="tab-acara-dki" role="tabpanel">
            @if ($kedutaanBesar->acaraDki->isNotEmpty())
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($kedutaanBesar->acaraDki as $item)
                                <tr>
                ...
                @foreach ($kedutaanBesar->acaraDki as $item)
                    <div class="modal modal-blur fade" id="modal-acara-dki-{{ $item->id_acara_dki }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title">Rincian Acara DKI - {{ $kedutaanBesar->mitra->nama_mitra }}</h3>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                ...
                @endforeach
            @else
                <p class="text-danger mb-0">Belum ada riwayat acara DKI untuk kedutaan ini.</p>
            @endif
        </div>
