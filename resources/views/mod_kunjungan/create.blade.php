                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('kunjungan.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="perihal" class="form-control" rows="5" placeholder="Tuliskan perihal kunjungan"></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Rangkuman</label>
                            <textarea name="rangkuman" class="form-control" rows="12" placeholder="Rangkuman singkat kunjungan"></textarea>
                        </div>
                        <div class="mb-3">
