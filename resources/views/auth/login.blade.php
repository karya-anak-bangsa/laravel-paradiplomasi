...
<html lang="id">
    ...
    <head>
        ...
        <title>Login - Paradiplomatic Compass Analytical System</title>
            ...
            <div class="container container-tight py-4">
                ...
                <div class="card card-md">
                    <div class="card-body">
                        ...
                        {{-- form login: hanya tampilan, belum ada proses autentikasi --}}
                        <form action="{{ route('dashboard.index') }}" method="GET" autocomplete="off" novalidate>

                            <div class="mb-3">
                                <label class="form-label">Alamat email</label>
                                <input type="email" class="form-control" placeholder="email@jakarta.go.id" autocomplete="off" />
                            </div>
