    ...
    <x-page-body-table title="Daftar undangan dari perwakilan negara asing">
        <x-slot name="thead">
            <tr>
                ...
                <th data-orderable="true" style="width:35%" class="text-start">Acara</th>
                    ...
                    <td class="text-center">
                        <div class="btn-list flex-nowrap justify-content-center">
                            ...
                            @if (session('auth_role') === 'admin')
                                ...
                                <form action="{{ route('undangan.destroy', $item) }}" method="post" class="d-inline"
                                    onsubmit="return confirm('Nonaktifkan undangan ini?')">
                                    @csrf @method('DELETE')
