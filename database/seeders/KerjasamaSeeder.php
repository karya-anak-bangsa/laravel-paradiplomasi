...
class KerjasamaSeeder extends Seeder
{
     ...
     * Migration tb_kerjasama tetap menggunakan SATU kolom foreign key `id_mitra`
     * (mengarah ke tb_mitra, tabel supertype generalisasi-spesialisasi dari
     * KedutaanBesar / MisiAsingAsean / MisiPermanenAsean).
     *
     * Namun, agar seeder ini TIDAK bergantung pada urutan insert tb_mitra
     * (yang rawan berubah jika urutan seeder Mitra di atas berubah), array
     * $data di bawah TIDAK menuliskan angka id_mitra secara hardcode.
     * Sebagai gantinya, setiap baris data menyimpan nama resmi mitra sesuai
     * kolom identitasnya masing-masing:
     ...
     * KedutaanBesarPart1-11Seeder, MisiAsingAseanSeeder, MisiPermanenAseanSeeder),
     * bukan istilah bebas pada sheet "Kerja Sama (KS)". Dua penyesuaian ejaan
     * dari sheet acuan ke seeder mitra:
     *   - "Kedutaan Besar Republik Somalia" (sheet) -> "Kedutaan Besar Republik Federal Somalia" (seeder mitra)
     *   - "Kedutaan Besar Turkiye" (sheet)          -> "Kedutaan Besar Turki" (seeder mitra)
     *
     * Saat proses seeding, nama tersebut di-lookup ke tabel anak terkait untuk
     * mengambil `id_mitra` (kolom yang sudah ada langsung di tabel anak, bukan
     * lewat relasi mitra()). Baris yang mitra-nya tidak ditemukan (mis. seeder
     * Mitra belum/tidak dijalankan, atau ejaan nama berubah) akan di-skip
     * (continue) agar seeder tidak gagal total.
     *
     ...
     * tidak disimpan karena tidak ada padanan kolom pada skema tb_kerjasama.
     */
    public function run(): void
    {
        $data = [
            [
                ...
                'catatan' => 'Jika terdapat catatan harap ditulis dan lengkapi link gdrive untuk akses dokumen kerjasama',
                'file_dokumen' => null,
